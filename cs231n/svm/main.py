...
tic = time.time()
_, grad_vectorized = linear_svm.svm_loss_vectorized(W, X_dev, y_dev, 0.000005)
toc = time.time()
...
learning_rates = [1e-8, 3e-7, 1e-7, 3e-6]
regularization_strengths = [1e3,1e4, 2e4, 2.5e4, 4e4, 5e4, 6e4, 7e4, 1e5, 1e6]
